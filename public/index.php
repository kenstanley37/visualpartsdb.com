...
session_start();
include("../path.php");
require_once($path.'/public/vendor/autoload.php');
...
$sku_count = $sku->getSkuCount();
$search_count = $sku->getSearchCount();
$image_count = $sku->getImageCount();
...
<head>
    ...
    <?php include($path."/public/inc/inc.head.php"); ?> <!-- META, CSS, and JavaScript -->
</head>
<body>
    <div class="wrapper">
        <header>
            <?php include($path."/public/inc/inc.header.php"); ?>
        </header>
        ...
        {
        ?>
            <?php include($path."/public/inc/inc.adminnavbar.php"); ?>
        <?php
        }
        ?>
        </aside>
        <main id="aboutvpd" class="index-main">
            ...
            <article class="main-intro">
                <div class="brands indexCard box shadow-5">
                    <h2 class="block-title box shadow-5">Brands</h2>
                ...
                <section class="information box shadow-5">
                    <h2 class="block-title box shadow-5">Information</h2>
                ...
                <div id="staticImg">
                    <?php
                        ...
                        {
                            ?>
                             <figure class="card bg-white box blog-shadow-sharp">
                                <div class="card-img">
            ...
            <article id="member">
                ...
                <section class="member-info box shadow-5">
                ...
                <section class="member-request box shadow-5">
