...
if(isset($_POST['Login'])){
    ...
    $email = $sec->sanitizeString($_POST['email']);
    $pass = $sec->sanitizeString($_POST['password']);  
    // Build POST request:
    $recaptcha_url = 'https://www.google.com/recaptcha/api/siteverify';
    $recaptcha_secret = $config['SERVER_KEY'];
                    ...
                    <div class="form-contact">
                        ...
                        <script>
                            grecaptcha.ready(function() {
                                grecaptcha.execute('<?php echo $config['SITE_KEY']; ?>', {action: 'login'}).then(function(token) {
